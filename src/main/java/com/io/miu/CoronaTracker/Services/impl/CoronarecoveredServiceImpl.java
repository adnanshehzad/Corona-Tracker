...
@Service
public class CoronarecoveredServiceImpl implements ICoronaService {
    private List<CoronaData> allstats=new ArrayList<>();
    private String coronadataurl_recovered="https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recovered_global.csv";
    private Iterable<CSVRecord> records;
    @Override
    public List<CoronaData> fetchcasesdata() throws IOException, InterruptedException {
        getdataonServerStart(coronadataurl_recovered);
